...
public final class SupportedPluginsManager {
    ...
    public static final String CORE_NOTE = ThemeUtils.MAIN + "SlimeTinker";
    public static final String INFINITY_EXPANSION_NOTE = ThemeUtils.ADD_INFINITY + "InfinityExpansion";
    public static final String SLIMEFUN_WARFARE_NOTE = ThemeUtils.ADD_SLIMEFUN_WARFARE + "SlimefunWarfare";
