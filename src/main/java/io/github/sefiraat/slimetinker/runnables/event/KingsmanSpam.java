...
public class KingsmanSpam implements Runnable {
    ...
    public void run() {
        ...
        current.getWorld().spawnParticle(Particle.DUST, l1, 30, 3, 3, 3, 1, d1);
        current.getWorld().spawnParticle(Particle.DUST, l2, 30, 3, 3, 3, 1, d2);
        current.getWorld().spawnParticle(Particle.DUST, l3, 30, 3, 3, 3, 1, d3);
        current.getWorld().spawnParticle(Particle.DUST, l4, 30, 3, 3, 3, 1, d4);
        current.getWorld().spawnParticle(Particle.DUST, l5, 30, 3, 3, 3, 1, d5);
